...
#define PanSource	"lights_v2.pml"
...
#define PSafety	((P3 *)_this)
typedef struct P3 { /* Safety */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define PPedestrianLight	((P2 *)_this)
typedef struct P2 { /* PedestrianLight */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
	unsigned _priority : 8; /* 0..255 */
#endif
	unsigned _6_17_tmp : 1;
	int this;
	int counter;
	int other;
} P2;
#define Air2	(sizeof(P2) - Offsetof(P2, other) - 1*sizeof(int))

#define PTrafficLight	((P1 *)_this)
typedef struct P1 { /* TrafficLight */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air1	(sizeof(P1) - Offsetof(P1, other) - 1*sizeof(int))

#define PSignal	((P0 *)_this)
typedef struct P0 { /* Signal */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, light) - 1*sizeof(int))
