...
#define pthread_equal(a,b)	((a)==(b))
	...
	case 2: /* generic 'else' */
		...
		_m = 3; goto P999;
		 ...
		 /* PROC :init: */
	case 3: // STATE 1 - lights_v2.pml:113 - [(run TrafficLight(0))] (0:0:0 - 1)
		IfNotBlocked
		reached[4][1] = 1;
		if (!(addproc(II, 1, 1, 0)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 4: // STATE 2 - lights_v2.pml:114 - [(run TrafficLight(1))] (0:0:0 - 1)
		IfNotBlocked
		reached[4][2] = 1;
		if (!(addproc(II, 1, 1, 1)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 5: // STATE 3 - lights_v2.pml:116 - [(run PedestrianLight(0))] (0:0:0 - 1)
		IfNotBlocked
		reached[4][3] = 1;
		if (!(addproc(II, 1, 2, 0)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 6: // STATE 4 - lights_v2.pml:117 - [(run PedestrianLight(1))] (0:0:0 - 1)
		IfNotBlocked
		reached[4][4] = 1;
		if (!(addproc(II, 1, 2, 1)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 7: // STATE 5 - lights_v2.pml:119 - [(run Signal(40))] (0:0:0 - 1)
		IfNotBlocked
		reached[4][5] = 1;
		if (!(addproc(II, 1, 0, 40)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 8: // STATE 6 - lights_v2.pml:122 - [(run Safety())] (0:0:0 - 1)
		IfNotBlocked
		reached[4][6] = 1;
		if (!(addproc(II, 1, 3, 0)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 9: // STATE 7 - lights_v2.pml:123 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[4][7] = 1;
		...
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC Safety */
	case 10: // STATE 1 - lights_v2.pml:100 - [assert(!(((LStates[0]==GREEN)&&(LStates[1]==GREEN))))] (0:0:0 - 1)
		IfNotBlocked
		reached[3][1] = 1;
		spin_assert( !(((now.LStates[0]==2)&&(now.LStates[1]==2))), " !(((LStates[0]==2)&&(LStates[1]==2)))", II, tt, t);
		_m = 3; goto P999; /* 0 */
	case 11: // STATE 2 - lights_v2.pml:101 - [assert(!(((LStates[0]==AMBER)&&(LStates[1]==AMBER))))] (0:0:0 - 1)
		IfNotBlocked
		reached[3][2] = 1;
		spin_assert( !(((now.LStates[0]==1)&&(now.LStates[1]==1))), " !(((LStates[0]==1)&&(LStates[1]==1)))", II, tt, t);
		_m = 3; goto P999; /* 0 */
	case 12: // STATE 3 - lights_v2.pml:102 - [assert(!(((LStates[0]==AMBER)&&(LStates[1]==GREEN))))] (0:0:0 - 1)
		IfNotBlocked
		reached[3][3] = 1;
		spin_assert( !(((now.LStates[0]==1)&&(now.LStates[1]==2))), " !(((LStates[0]==1)&&(LStates[1]==2)))", II, tt, t);
		_m = 3; goto P999; /* 0 */
	case 13: // STATE 4 - lights_v2.pml:103 - [assert(!(((LStates[0]==GREEN)&&(LStates[1]==AMBER))))] (0:0:0 - 1)
		IfNotBlocked
		reached[3][4] = 1;
		spin_assert( !(((now.LStates[0]==2)&&(now.LStates[1]==1))), " !(((LStates[0]==2)&&(LStates[1]==1)))", II, tt, t);
		_m = 3; goto P999; /* 0 */
	case 14: // STATE 5 - lights_v2.pml:106 - [assert(!(((PStates[0]==GREEN)&&(LStates[1]==GREEN))))] (0:0:0 - 1)
		IfNotBlocked
		reached[3][5] = 1;
		spin_assert( !(((now.PStates[0]==2)&&(now.LStates[1]==2))), " !(((PStates[0]==2)&&(LStates[1]==2)))", II, tt, t);
		_m = 3; goto P999; /* 0 */
	case 15: // STATE 6 - lights_v2.pml:107 - [assert(!(((PStates[1]==GREEN)&&(LStates[0]==GREEN))))] (0:0:0 - 1)
		IfNotBlocked
		reached[3][6] = 1;
		spin_assert( !(((now.PStates[1]==2)&&(now.LStates[0]==2))), " !(((PStates[1]==2)&&(LStates[0]==2)))", II, tt, t);
		_m = 3; goto P999; /* 0 */
	case 16: // STATE 10 - lights_v2.pml:109 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[3][10] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
	...
	case 19: // STATE 5 - lights_v2.pml:20 - [(tmp)] (0:0:1 - 1)
		...
		if (!readtrail)
			...
			((P2 *)_this)->_6_17_tmp = 0;
		_m = 3; goto P999; /* 0 */
	case 20: // STATE 14 - lights_v2.pml:85 - [(((LStates[other]==RED)&&(Peds[0]>0)))] (0:0:0 - 1)
		IfNotBlocked
		reached[2][14] = 1;
		if (!(((now.LStates[ Index(((P2 *)_this)->other, 2) ]==3)&&(now.Peds[0]>0))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 21: // STATE 16 - lights_v2.pml:85 - [printf('P%d->Green\\n',this)] (0:37:2 - 1)
		IfNotBlocked
		reached[2][16] = 1;
		Printf("P%d->Green\n", ((P2 *)_this)->this);
		/* merge: PStates[this] = GREEN(37, 17, 37) */
		reached[2][17] = 1;
		(trpt+1)->bup.ovals = grab_ints(2);
		...
		;
		_m = 3; goto P999; /* 3 */
	case 22: // STATE 20 - lights_v2.pml:88 - [(((PStates[this]==GREEN)&&(counter>0)))] (0:0:0 - 1)
		IfNotBlocked
		reached[2][20] = 1;
		if (!(((now.PStates[ Index(((P2 *)_this)->this, 2) ]==2)&&(((P2 *)_this)->counter>0))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 23: // STATE 22 - lights_v2.pml:88 - [printf('P%d-Green%d\\n',this,counter)] (0:37:2 - 1)
		IfNotBlocked
		reached[2][22] = 1;
		Printf("P%d-Green%d\n", ((P2 *)_this)->this, ((P2 *)_this)->counter);
		/* merge: counter = (counter-1)(37, 23, 37) */
		reached[2][23] = 1;
		(trpt+1)->bup.ovals = grab_ints(2);
		(trpt+1)->bup.ovals[0] = ((P2 *)_this)->counter;
		((P2 *)_this)->counter = (((P2 *)_this)->counter-1);
#ifdef VAR_RANGES
		logval("PedestrianLight:counter", ((P2 *)_this)->counter);
#endif
		;
		/* merge: Peds[0] = (Peds[0]-1)(37, 24, 37) */
		reached[2][24] = 1;
		(trpt+1)->bup.ovals[1] = now.Peds[0];
		now.Peds[0] = (now.Peds[0]-1);
#ifdef VAR_RANGES
		logval("Peds[0]", now.Peds[0]);
#endif
		;
		/* merge: .(goto)(0, 35, 37) */
		reached[2][35] = 1;
		;
		_m = 3; goto P999; /* 3 */
	case 24: // STATE 26 - lights_v2.pml:89 - [(((PStates[this]==GREEN)&&(counter==0)))] (0:0:0 - 1)
		IfNotBlocked
		reached[2][26] = 1;
		if (!(((now.PStates[ Index(((P2 *)_this)->this, 2) ]==2)&&(((P2 *)_this)->counter==0))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 25: // STATE 28 - lights_v2.pml:89 - [printf('P%d->RED\\n',this)] (0:37:2 - 1)
		IfNotBlocked
		reached[2][28] = 1;
		Printf("P%d->RED\n", ((P2 *)_this)->this);
		/* merge: PStates[this] = RED(37, 29, 37) */
		reached[2][29] = 1;
		(trpt+1)->bup.ovals = grab_ints(2);
		(trpt+1)->bup.ovals[0] = now.PStates[ Index(((P2 *)_this)->this, 2) ];
...
#endif
		;
		/* merge: Peds[0] = (Peds[0]-1)(37, 30, 37) */
		reached[2][30] = 1;
		(trpt+1)->bup.ovals[1] = now.Peds[0];
		now.Peds[0] = (now.Peds[0]-1);
#ifdef VAR_RANGES
		...
		;
		_m = 3; goto P999; /* 3 */
	case 26: // STATE 36 - lights_v2.pml:28 - [lock = 0] (0:0:1 - 1)
		IfNotBlocked
		reached[2][36] = 1;
	...
	case 31: // STATE 16 - lights_v2.pml:60 - [printf('L%d->Green\\n',this)] (0:56:2 - 1)
		...
		;
		_m = 3; goto P999; /* 3 */
	case 32: // STATE 20 - lights_v2.pml:63 - [((((LStates[this]==GREEN)&&(Cars[other]==0))&&(counter==5)))] (0:0:0 - 1)
		IfNotBlocked
		reached[1][20] = 1;
		if (!((((now.LStates[ Index(((P1 *)_this)->this, 2) ]==2)&&(now.Cars[ Index(((P1 *)_this)->other, 2) ]==0))&&(((P1 *)_this)->counter==5))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 33: // STATE 22 - lights_v2.pml:63 - [printf('L%d-GreenInf\\n',this)] (0:56:1 - 1)
		...
		;
		_m = 3; goto P999; /* 2 */
	case 34: // STATE 25 - lights_v2.pml:64 - [((((LStates[this]==GREEN)&&(counter>0))&&(counter<5)))] (0:0:0 - 1)
		IfNotBlocked
		reached[1][25] = 1;
		if (!((((now.LStates[ Index(((P1 *)_this)->this, 2) ]==2)&&(((P1 *)_this)->counter>0))&&(((P1 *)_this)->counter<5))))
			continue;
		_m = 3; goto P999; /* 0 */
