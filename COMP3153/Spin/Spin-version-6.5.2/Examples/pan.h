...
#define PanSource	"calculator.pml"
...
#define _nstates1	14	/* :init: */
#define minseq1	23
#define maxseq1	35
#define _endstate1	13

#define _nstates0	24	/* calc */
#define minseq0	0
#define maxseq0	22
...
#define Air1	(sizeof(P1) - Offsetof(P1, result) - 1*sizeof(int))

#define Pcalc	((P0 *)_this)
typedef struct P0 { /* calc */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, rgt) - 1*sizeof(int))
