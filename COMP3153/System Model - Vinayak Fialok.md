...
- **Abstracting the timer away so everything just lasts 1 tick.** Although this does allows us to model the system more simply without losing significant simplicity, I have chosen to allow 
