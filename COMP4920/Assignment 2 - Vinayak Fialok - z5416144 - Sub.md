...
Essential to transparency is accessible and understandable explanation, which is not trivial. Grayson mentions 4 models of explanation, of these we will consider the deductive-nomological model, and the causal model. We find that both of these models are effective a
