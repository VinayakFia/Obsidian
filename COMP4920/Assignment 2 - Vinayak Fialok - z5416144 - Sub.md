...
Through rule-lists, researches created the CORELS algorithm which was "competitive with scores generated by the COMPAS algorithm" (Angelino et al 2018). As such, CORELS becomes transparent without diminished accuracy.
