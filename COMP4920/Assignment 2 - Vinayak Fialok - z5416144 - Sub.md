...
From our earlier example, we substitute $c$ with"Bob feels tired and believes there is coffee in the fridge" and e with "Bob goes to the fridge". Schema $C$ is for causal explanation, the underlying causal relationship must also be proved. Proving causal relationships is not trivial. The methods of proof of causal relationships are complex, and "unfortunately, valid explanations of the causes of social phenomena do not come easily" (Chambliss 2018). Methods can include statistical inference, longitudanal studies, and controlled trials. These methods are discussed in greater detail in Chambliss' book 'Making sense of the social world'.
