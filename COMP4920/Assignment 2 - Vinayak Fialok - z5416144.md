...
Grayson approaches human decision making through the belief/ desire psychological model. A parallel model and largely similar model, the belief-desire-intention (BDI) agent model, was developed by Michael Bratman to reason human decisions. **CHECK THIS**
...
### 2.2 Accountability
Borrowing from Grayson, we identify that accountability requires reasons (Grayson 2024 p5). It is because a de
