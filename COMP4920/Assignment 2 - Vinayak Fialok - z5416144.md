...
Rule-list 1 may be accepted as normatively salient as it only distinguishes risk based on prior convictions. We can argue this reasoning is moral through rule-based utilitarianism as a world where prior convictions are considered higher risk for recidivism
### References
