...
Reasoning is the process in which a human or machine come to a decision. An explanation is the conveying of our reasoning to others. We can think of the translation b. This process is direct for human decision making as the parameters of the decision are themselves. It is intuitive to convey beliefs and desires, and then through causal explanation, counterfactual or otherwise, convey that through one's beliefs and desires, they have made a decision.
