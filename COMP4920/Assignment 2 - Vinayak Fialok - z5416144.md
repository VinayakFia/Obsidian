...
If our criminal from our aforementioned case was aged 19 and male we could explain causally to him that "because you are 19 and male, we have decided that you will re-offend". Through rule-lists as above, researches created the CORELS algorithm which was "competitive with scores generated by the COMPAS algorithm" (Angelino et al 2018).
