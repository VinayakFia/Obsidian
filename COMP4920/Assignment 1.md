...
I will consider two approaches for the automation of Kantian ethics. Firstly, end-to-end automation through the use of neural networks and machine learning. Secondly, we will explore automation through formalisation of the Categorial imperative into proof software.
...
AI ethics based upon neural networks is fundamentally incompatible with Kantian ethics. In comparison to 
