...
The notion of a Kantian artificial moral agent, regardless of implementation challenges, fundamentally opposes the categorical imperative. . Moreover, Kant's formula of humanity (FH) - specifically to treat individuals as ends in themselves never as a mere means - requires that the persons capable of moral evaluation must be considered as ends in themselves (Nath, R., and Sahu, V. 2021). 
